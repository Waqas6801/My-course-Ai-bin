...
ids, price , long , lat = np.genfromtxt(r'C:\Users\dell\Documents\GitHub\My-course-Ai-bin\Real_Estate_Sales_2001-2022_GL-Short.csv', delimiter=',',usecols=(0,5,6,7),  unpack=True, dtype=None,skip_header=1,invalid_raise=False,    filling_values=0)
