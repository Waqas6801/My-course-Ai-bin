...
ids, price , long , lat = np.genfromtxt(r'C:\Users\dell\Documents\GitHub\My-course-Ai-bin\startup_growth_investment_data.csv', delimiter=',', usecols=(2,3,4,8), unpack=True, dtype=None,skip_header=1)
